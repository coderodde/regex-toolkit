    ...
    private DeterministicFiniteAutomaton buildDfaImpl(
        ...
        for (Set<DeterministicFiniteAutomatonState> equivalenceClass 
            ...
            for (CodePointRange codePointRange 
                : getLocalAlphabet(equivalenceClass)) {
                ...
                currentDfaState.addFollowerState(codePointRange, nextDfaState);
            }
        }
...
//        pruneUnreachableStates(reachableStates);
        ...
        while (!w.isEmpty()) {
            ...
            for (CodePointRange codePoint : getLocalAlphabet(a)) {
    ...
    private Set<DeterministicFiniteAutomatonState> 
        getX(CodePointRange codePointRange,
        ...
        for (DeterministicFiniteAutomatonState q : this.states) {
            if (a.contains(q.traverse(codePointRange))) {
                x.add(q);
            }
        }
